...
// Compile-time check that *BassFretBoard implements Diagram.
var _ Diagram = (*BassFretBoard)(nil)

func NewBassDiagram() Diagram {
	fb := &BassFretBoard{scaleLength: 25.5, numFrets: 6,
		canvasWidth: 1188, canvasHeight: 940, strings: 4}
...
func (fb *BassFretBoard) DrawDiagram() {
...
func (fb *BassFretBoard) ColorScale(interval []string) {
...
func (fb *BassFretBoard) DrawInterval(note string, x, y, radius float64, textColor color.RGBA) {
...
func (fb *BassFretBoard) DrawTitle(scaleName, scaleNotes string, x, y float64) {
...
func (fb *BassFretBoard) SaveScaleDiagram(filename string) {
...
func (fb *BassFretBoard) getFlatName(interval string) string {
...
func (fb *BassFretBoard) TilePNGsToPDF(inputDir, outPDFPath string) error {
